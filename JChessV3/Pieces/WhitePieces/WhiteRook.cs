...
namespace JChessV3.Pieces.WhitePieces
{
    class WhiteRook
    {
        ...
        /// <summary>
        /// Generates the moves for a White Rook. Does not account for pins. TODO: Castling.
        /// </summary>
        ...
        public int[,] GenerateThreats(int[,] inputArr, int row, int column)
        {
            ...
            for (int i = 1; !stopped; i++)
            {
                ...
                if (row_i >= 0)
                {
                    if (inputArr[row_i, column] == 0 || inputArr[row_i, column] == Const.BLACK_KING || inputArr[row_i, column] == Const.C_BLACK_KING)
                    {
            ...
            for (int i = 1; !stopped; i++)
            {
                ...
                if (col_i >= 0)
                {
                    if (inputArr[row, col_i] == 0 || inputArr[row, col_i] == Const.BLACK_KING || inputArr[row, col_i] == Const.C_BLACK_KING)
                    {
